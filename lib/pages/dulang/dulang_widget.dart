                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          mainAxisSize: MainAxisSize.min,
                          children: List.generate(videos.length, (videoIndex) {
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    videoItem.publishedAt != null
                                                        ? '${videoItem.channelName} • ${dateTimeFormat("dd/MM/y", videoItem.publishedAt!, locale: FFLocalizations.of(context).languageCode)}'
                          ...
                          }).divide(SizedBox(height: 16.0)).toList(),
                        ),
                      ),
